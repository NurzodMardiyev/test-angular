...
export class Devided implements OnInit {
   ...
   */
  createNew() {
    this.router.navigate(['/services/devided/application'], {
      queryParamsHandling: 'preserve', // button=xxx saqlanib qoladi
    });
  }
